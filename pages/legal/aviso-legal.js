...
const AvisoLegal = () => {
  return (
    <>
      <Hero image={heroImage} title="Aviso Legal" />
      <div className={styles.legalWrapper}>
        ...
        <h2>Finalidad</h2>
        <p>
          La finalidad del sitio Web https://www.victormartinezgaleote.com es
          ofrecer información sobre mi carrera profesional y los servicios que
          ofrezco como músico.
        </p>
        ...
        <p>
          ...
          relación comercial con Víctor Martínez Galeote.
        </p>
        ...
        <p>
          ...
          cualquier equipo informático propios o contratados por Víctor Martínez
          Galeote, de otros usuarios o de cualquier usuario de Internet.
        </p>

        <p>
          El Titular se reserva el derecho de retirar todos aquellos comentarios
          que vulneren la legislación vigente, lesivos de los derechos o
          intereses de terceros, o que, a su juicio, no resulten adecuados para
          su publicación.
        </p>

        <p>
          Víctor Martínez Galeote no será responsable de las opiniones vertidas
          por los usuarios a través del sistema de comentarios, u otras
          herramientas de participación, conforme a lo previsto en la normativa
          de aplicación.
        </p>
        ...
        <p>
          ...
          exclusiva a Víctor Martínez Galeote, que asume todas las medidas de
        ...
        <p>
          ...
          exacta, completa o actualizada. Víctor Martínez Galeote declina
          expresamente cualquier responsabilidad por error u omisión en la
          información contenida en las páginas de este sitio Web.
        </p>
        ...
        <p>
          Los contenidos de https://www.victormartinezgaleote.com tienen
        ...
        <p>
          Víctor Martínez Galeote se reserva el derecho a modificar, suspender,
          cancelar o restringir el contenido de
          https://www.victormartinezgaleote.com, los vínculos o la información
          obtenida a través del sitio Web, sin necesidad de previo aviso.
        </p>

        <p>
          Víctor Martínez Galeote no es responsable de los daños y perjuicios
        ...
        <p>
          En la página Política de Cookies puede consultar toda la información
          relativa a la política de recogida y tratamiento de las cookies.
        </p>
        ...
        <p>
          ...
          sugerencia o recomendación para que usted visite las páginas web de
          destino, que están fuera del control del Titular, por lo que Víctor
          Martínez Galeote no es responsable del contenido de los sitios web
          vinculados ni del resultado que obtenga al seguir los enlaces.
        </p>

        <p>
          Asimismo, Víctor Martínez Galeote no responde de los links o enlaces
          ubicados en los sitios web vinculados a los que le proporciona acceso.
        </p>

        <p>
          El establecimiento del enlace no implica en ningún caso la existencia
          de relaciones entre Víctor Martínez Galeote y el propietario del sitio
          en el que se establezca el enlace, ni la aceptación o aprobación por
          parte del Titular de sus contenidos o servicios.
        </p>

        <p>
          Si accede a un sitio Web externo desde un enlace que encuentre en
          https://www.victormartinezgaleote.com usted deberá leer la propia
        ...
        <p>
          ...
          la reproducción, almacenaje permanente y la difusión de los contenidos
          o cualquier otro uso que tenga finalidad pública o comercial queda
          expresamente prohibida sin el consentimiento previo expreso y por
          escrito de Víctor Martínez Galeote.
        </p>

        <h2>Limitación de responsabilidad</h2>
        <p>
          Víctor Martínez Galeote declina cualquier responsabilidad en caso de
          que existan interrupciones o un mal funcionamiento de los Servicios o
          ...
          temporales de fluido eléctrico o cualquier otro tipo de daño indirecto
          que te pueda ser causado por causas ajenas a el Titular.
        </p>

        <p>
          Antes de tomar decisiones y/o acciones con base a la información
          incluida en el sitio Web, el Titular le recomienda comprobar y
        ...
        <h2>Contacto</h2>
        <p>
          En caso de que usted tenga cualquier duda acerca de estas Condiciones
          legales o quiera realizar cualquier comentario sobre este sitio Web,
